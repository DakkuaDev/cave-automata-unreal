#undef CONWAY_CELL_AUTOMATA_API
...
#define UE_PROJECT_NAME Conway_Cell_Automata
#define UE_TARGET_NAME Conway_Cell_AutomataEditor
...
#define CONWAY_CELL_AUTOMATA_API DLLEXPORT
