...
/// <summary>
/// Función de generado de cueva principal
/// </summary>
void AConwayAutomata::GenerateMap()
{
	for (int x = 0; x < width; ++x)
	{
		for (int y = 0; y < height; ++y)
		{
			...
			// Se genera un número aleatorio para determinar el estado de la célula
			else
			{
				float rand;
...
/// <summary>
/// Función de coloreado. Se basa en el type de las células
/// </summary>
...
/// <summary>
/// Pasadas para lograr un resultado procedural más natural del aspecto de la cueva
/// </summary>
...
/// <summary>
/// Función para obtener los vecinos de las células cercanas
/// </summary>
/// <param name="gridX"> valores hirizontales</param>
/// <param name="gridY"> valores verticales</param>
/// <returns> devuelvo el total de células que son pared</returns>
